...
export default function Home() {
  return (
    <div className="font-sf antialiased px-5 dark:bg-black dark:text-white">
      <Head>
      ...
      <section className="px-5 pt-10 pb-16 md:p-16">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-3">
          <div className="flex flex-col">
            ...
            <div className="my-5">
              <h3 className="font-c text-3xl text-blue-450 dark:text-red-500">
                <a href="#">rendr</a>
              </h3>
              <p className="text-base my-2 text-black dark:text-blue-300">
                Serverless drag-and-drop
                <br />
                cloud rendering for Blender
              </p>
            </div>

            <div className="my-5">
              <h3 className="font-c text-3xl text-blue-450 dark:text-red-500">
                <a href="#">playlist hunt</a>
              </h3>
              <p className="text-base my-2 text-black dark:text-blue-300">
          ...
          <div className="flex flex-col md:col-span-2 md:w-full">
            ...
            <div className="my-5">
              <h3 className="font-c text-3xl text-blue-450 dark:text-red-500">
                <a href="#">How To Get People To Answer Your Surveys</a>
              </h3>
              <p className="text-base my-2 text-black dark:text-blue-300">
                There's a simple trick to get people to do anything. Put a
                carrot on a string and hang it in front of their eyes.
              </p>
            </div>

            <div className="my-5">
              <h3 className="font-c text-3xl text-blue-450 dark:text-red-500">
                <a href="#">The ONE thing Sundar Pichai taught me</a>
              </h3>
              <p className="text-base my-2 text-black dark:text-blue-300">
                We don’t know each other in real life and this is clickbait. You
